...
ViroMaterials.createMaterials({
  tv: {
    shininess: 2.0,
    lightingModel: 'Blinn',
    diffuseTexture: require('./public/images/tv_diffuse.png'),
    specularTexture: require('./public/images/tv_specular.png'),
  },
  camera_body: {
    shininess: 2.0,
    lightingModel: 'Blinn',
    cullMode: 'None',
    diffuseTexture: require('./public/images/camera_body_diffuse.png'),
    specularTexture: require('./public/images/camera_body_specular.png'),
  },
  camera_lens: {
    shininess: 2.0,
    lightingModel: 'Blinn',
    cullMode: 'None',
    diffuseTexture: require('./public/images/camera_lens_diffuse.png'),
    specularTexture: require('./public/images/camera_lens_specular.png'),
  },
  opaque: {
...
var products = [
  {
    ...
    online: true,
    giftWrappable: true,
    productVideo: require('./public/images/tv_vid.mp4'),
    previewImage: require('./public/images/btn_tv.png'),
    // model information
    objects: [require('./public/images/tv.obj')],
    objectOffset: [0, 0, 0],
  ...
  },
  {
    ...
    online: false,
    giftWrappable: true,
    productVideo: require('./public/images/camera_vid.mp4'),
    previewImage: require('./public/images/btn_camera.png'),
    // model information
    objects: [
      require('./public/images/camera_body.obj'),
      require('./public/images/camera_lens.obj'),
    ],
...
var ProductShowcase = createReactClass({
  ...
  render: function () {
    ...
    return (
      <ViroScene>
        <Viro360Image source={require('./public/images/interior_viro.jpg')} />
