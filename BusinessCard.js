...
export class BusinessCard extends Component {
              ...
              <ViroFlexView
                ...
                <ViroFlexView
                  ...
                  <ViroAnimatedImage
                    ...
                    width={0.01}
                    loop={true}
                    source={require('./public/images/tweet.gif')}
                  />
                </ViroFlexView>
              </ViroFlexView>
            </ViroNode>
  ...
  render() {
    console.log('render Business Card');
  ...
  _onInitialized = (state, reason) => {
    ...
    console.log(state);
    console.log(ViroTrackingStateConstants);
    if (state == ViroTrackingStateConstants.TRACKING_NORMAL) {
      console.log('trackin normal');
...
ViroARTrackingTargets.createTargets({
  businessCard: {
    source: require('./public/images/card.jpg'),
    orientation: 'Up',
